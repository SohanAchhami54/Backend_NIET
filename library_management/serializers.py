...
class BookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Book
        fields = [
            'id', 'name', 'keyword', 'classification_number', 'author', 'publisher','category','accession_number',
            'is_active','available'
        ]
...
class BorrowerSerializer(serializers.ModelSerializer):
    ...
    total_borrowed = serializers.SerializerMethodField()
    class Meta:
        model = Borrower
        fields = ['id','borrower_type','name','email','phone','library_id','total_borrowed']
    def get_total_borrowed(self, obj):
        is_issued = Transaction.objects.filter(borrower=obj, has_returned=False)
        return len(is_issued)
...
class TransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transaction
        fields = ['id','borrower','book','from_date','returned_date','has_returned','issued_by']
